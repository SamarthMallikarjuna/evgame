...
// Sign Up Handler: Creates Account & Switches to Login View
...
// Login Handler: Authenticates Account & Activates Session
...
if (submitLbBtn) {
    submitLbBtn.addEventListener('click', () => {
        ...
        if (existingIdx !== -1) {
            // Update existing player entry if new score is higher or equal
        ...
        showToast('🏆', 'SCORE ADDED TO LEADERBOARD!');
